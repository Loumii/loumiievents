...
// in simulator we redefine to format for Loumii Developer console
...
{\
	NSString * exceptionName = [@"org.loumii." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.loumii";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UILoumiiNativeItemNone = -1, 
	UILoumiiNativeItemSpinner = -2,
	UILoumiiNativeItemProgressBar = -3,
	
	UILoumiiNativeItemSlider = -4,
	UILoumiiNativeItemSwitch = -5,
	UILoumiiNativeItemMultiButton = -6,
	UILoumiiNativeItemSegmented = -7,
	
	UILoumiiNativeItemTextView = -8,
	UILoumiiNativeItemTextField = -9,
	UILoumiiNativeItemSearchBar = -10,
	
	UILoumiiNativeItemPicker = -11,
	UILoumiiNativeItemDatePicker = -12,
	
	UILoumiiNativeItemInfoLight = -13,
	UILoumiiNativeItemInfoDark = -14,
	
	UILoumiiNativeItemDisclosure = -15,
	
	UILoumiiNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all Loumii instances of
