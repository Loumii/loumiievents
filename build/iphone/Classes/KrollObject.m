 ...
 * Copyright (c) 2009-2011 by Loumii, Inc. All Rights Reserved.
...
//@interface LoumiiObject : NSObject
//@end

@interface LoumiiObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[LoumiiObject class]])
		{
			for (NSString *key in [[(LoumiiObject*)o modules] allKeys])
			{
